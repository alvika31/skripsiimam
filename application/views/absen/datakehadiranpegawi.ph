                ...
                <div class="table-responsive">
                    <table class="table align-items-center mb-0">
                        <thead>
                            ...
                            <tr>
                                <td class="align-middle"><h6 class="mb-0 text-xs"><?=$i++?></h6></td>
                                <td class="align-middle"><h6 class="mb-0 text-xs"><?=date('l, d F Y', $tanggal)?></h6></td>
                                <td class="align-middle"><h6 class="mb-0 text-xs"><?=$users->username?></h6></td>
                                <?php if($users->keterangan_absen == 'Sakit'){ ?>
                                    <td class="align-middle"><h6 class="mb-0 text-xs"><span class="badge bg-gradient-danger">Sakit</span></h6></td>    
                                    <td class="align-middle"><h6 class="mb-0 text-xs"><span class="badge bg-gradient-danger">Sakit</span></h6></td>  
                                    <td class="align-middle"><h6 class="mb-0 text-xs"><span class="badge bg-gradient-danger">Sakit</span></h6></td>  
                                    
                                <?php }elseif($users->keterangan_absen == 'Cuti'){?>
                                    <td class="align-middle"><h6 class="mb-0 text-xs"><span class="badge bg-gradient-warning">Cuti</span></h6></td> 
                                    <td class="align-middle"><h6 class="mb-0 text-xs"><span class="badge bg-gradient-warning">Cuti</span></h6></td>
                                    <td class="align-middle"><h6 class="mb-0 text-xs"><span class="badge bg-gradient-warning">Cuti</span></h6></td>
                                    <?php }else{?>
                                        <td class="align-middle"><h6 class="mb-0 text-xs"><?=$users->jam_absen?></h6></td>
                                    <td class="align-middle"><h6 class="mb-0 text-xs"><?=$users->jam_absen_pulang?></h6></td>   
                                    <?php if($users->status_absen == 1){ ?>
                                <td class="align-middle"><h6 class="mb-0 text-xs"><span class="badge bg-gradient-danger">Belum Absen Pulang</span></h6></td>
                                <?php }elseif($users->status_absen == 2){?>
                                <td class="align-middle"><h6 class="mb-0 text-xs"><span class="badge bg-gradient-success">Sudah Absen </span></h6></td>
                                <?php }}?>
